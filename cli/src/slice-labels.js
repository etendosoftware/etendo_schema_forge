 ...
 *   2. Shared core:        tools/app-shell/src/locales/generated/core.<locale>.json
 ...
 *
 * Post-split note: locale dictionaries are owned by the host app (they moved out of
 * app-shell-core), so both the source dicts and the generated core live under
...
const LOCALES_DIR = join(ROOT, 'tools', 'app-shell', 'src', 'locales');
