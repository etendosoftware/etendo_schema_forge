          ...
          <div style={{ padding: '0 20px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 20, padding: '8px 12px', border: `1px solid ${BORDER1}`, borderRadius: 8, background: 'hsl(var(--card))' }}>
              ...
              <WidgetCell label={ui('cpPendingPrefix')} valueColor={AMBER} data-testid="WidgetCell__pending">
                <MoneyAmount value={total} currency={currency} tone="neutral" className="text-[var(--status-warning-fg)]" data-testid="MoneyAmount__cp-pending" />
              </WidgetCell>
            </div>
          </div>
          ...
          <div style={{ padding: '0 20px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap', padding: '8px 12px', borderRadius: 8, background: WIDGET_BG }}>
              ...
              {balance.usedCredit > 0 && (<>
                <span style={{ color: FG2, font: '400 12px/16px Inter' }}>+</span>
                <div><div style={{ font: '400 12px/16px Inter', color: 'hsl(var(--primary))' }}>{ui('cpFavorBadge')}</div><div style={{ font: '500 14px/20px Inter' }}><MoneyAmount value={balance.usedCredit} currency={currency} tone="neutral" className="text-[hsl(var(--primary))]" data-testid="MoneyAmount__cp-credit" /></div></div>
              </>)}
              <span style={{ color: FG2, font: '400 12px/16px Inter' }}>=</span>
              ...
              <div style={{ flex: 1 }} />
              <div style={{ textAlign: 'right' }}><div style={{ font: '400 12px/16px Inter', color: FG2 }}>{deltaLabel}</div><div style={{ font: '600 14px/20px Inter' }}><MoneyAmount value={Math.abs(balance.diff)} currency={currency} tone="neutral" className={balance.isPartial ? 'text-[hsl(var(--destructive))]' : 'text-[var(--status-success-fg)]'} data-testid="MoneyAmount__cp-delta" /></div></div>
