...
export function usePurchaseOrderPdf(orderId, apiBaseUrl, token, currencyData = null, cacheConfig = null) {
  const ui = useUI();
  ...
  return useDocumentPdf(orderId, apiBaseUrl, token, buildPurchaseOrderData, labels, cacheConfig);
}
