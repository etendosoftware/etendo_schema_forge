        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <DialogFooter data-testid="DialogFooter__cc1c8b">
            ...
            <button
              ...
              className="inline-flex h-10 items-center rounded-lg bg-[hsl(var(--foreground))] px-4 text-sm font-medium text-primary-foreground hover:bg-[hsl(var(--accent-highlight))] hover:text-[hsl(var(--accent-highlight-foreground))] disabled:opacity-50 disabled:cursor-not-allowed"
            >
