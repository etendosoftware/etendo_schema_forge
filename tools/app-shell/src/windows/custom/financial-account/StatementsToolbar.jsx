  ...
  return (
    <div ref={ref} className="relative flex items-stretch">
      <button
        ...
        className="inline-flex h-10 items-center gap-2 rounded-l-lg bg-[hsl(var(--foreground))] px-3 text-sm font-medium text-white transition-colors hover:bg-[hsl(var(--primary))] hover:text-[hsl(var(--foreground))]"
      >
      ...
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        className="inline-flex h-10 w-9 items-center justify-center rounded-r-lg border-l border-white/20 bg-[hsl(var(--foreground))] text-white transition-colors hover:bg-[hsl(var(--primary))] hover:text-[hsl(var(--foreground))]"
      >
        <ChevronDown
...
function SyncStatementsButton({ ui, onClick, syncing }) {
  return (
    <button
      ...
      onClick={onClick}
      disabled={syncing}
      className="inline-flex h-10 items-center gap-2 rounded-lg bg-[hsl(var(--foreground))] px-3 text-sm font-medium text-white transition-colors hover:bg-[hsl(var(--primary))] hover:text-[hsl(var(--foreground))] disabled:cursor-not-allowed disabled:opacity-60"
    >
      <RefreshCw
