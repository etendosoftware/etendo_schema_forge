...
function AccountingConfigurationSection({ ui, accounting }) {
  ...
  if (accounting.loading) {
    return (
      <p className="mt-4 text-xs text-muted-foreground" data-testid="accounting-configuration-loading">
  ...
  if (!accounting.ledgerConfigured) {
    return (
      <p className="mt-4 text-xs text-muted-foreground" data-testid="accounting-configuration-unconfigured">
