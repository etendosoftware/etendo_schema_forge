      ...
      <PopoverContent align="start" className="w-72 p-0" data-testid="PopoverContent__c66309">
        ...
        <div className="flex items-center justify-end gap-2 border-t border-[hsl(var(--border-subtle))] px-3 py-2">
          ...
          <button
            ...
            onClick={handleApply}
            disabled={!canApply}
            className="inline-flex h-9 items-center justify-center rounded-full bg-[hsl(var(--foreground))] px-3 text-sm font-medium text-primary-foreground transition-colors hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
          >
            {ui('dateRangeApply')}
          </button>
        </div>
