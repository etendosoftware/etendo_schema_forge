...
describe('ReturnToVendorShipmentPreview', () => {
  ...
  describe('ReceiptSendModal wiring', () => {
    ...
    // ETP-4576 — the credential argument is gone: the hook's requests build their
    // own headers from the active session scheme.
    it('calls useReturnToVendorPdf with the shipment id, apiBaseUrl and pdfCacheConfig', () => {
      renderPreview();
