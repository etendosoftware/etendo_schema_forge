...
export const SECTION_COLORS = {
  ...
  Sales: { accent: '#2563eb', bg: 'bg-blue-50', border: 'focus:border-focus-ring', text: 'text-blue-600' },
  ...
  Settings: { accent: '#6b7280', bg: 'bg-muted', border: 'border-border-control', text: 'text-muted-foreground' },
};
