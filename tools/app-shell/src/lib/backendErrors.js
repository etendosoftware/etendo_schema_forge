const BACKEND_ERROR_MAP = {
  ...
  // client-side against the same key (`movementDeleteEligibility.js`), so this entry now covers
  ...
  // place. `movementDeleteEligibility.js` picks the SAME two keys client-side off
