...
export function ValerIATile({ size = 32, radius = 8 }) {
  return (
    <div style={{
      ...
      background: 'linear-gradient(180deg,hsl(var(--accent-highlight)) 0%,hsl(var(--accent-highlight)) 100%)',
      display: 'flex', alignItems: 'center', justifyContent: 'center',
      flexShrink: 0,
    }}>
      <svg viewBox="0 0 20.241 20" width={size * 0.5} height={size * 0.5} fill="hsl(var(--accent-highlight-foreground))">
