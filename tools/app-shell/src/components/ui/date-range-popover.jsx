        ...
        <div className="flex h-16 items-center justify-between gap-2 px-5 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-full bg-foreground px-3 text-sm font-medium text-white transition-colors hover:bg-primary hover:text-foreground disabled:cursor-not-allowed disabled:opacity-40"
            >
              {ui('dateRangeApply')}
            </button>
          </div>
