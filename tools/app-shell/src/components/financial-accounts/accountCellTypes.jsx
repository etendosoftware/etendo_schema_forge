...
import { NameCell, TypeCell, BalanceCell, CountryCell, CurrencyCell } from './AccountsTable/accountColumns.jsx';
...
export const ACCOUNT_CELL_TYPES = {
  ...
  currencyChip: (row) => <CurrencyCell account={row} data-testid="CurrencyCell__c4cfe9" />,
