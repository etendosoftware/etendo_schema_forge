      ...
      <div className="flex items-center justify-between gap-2 px-2 pt-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="group inline-flex h-10 items-center gap-1.5 rounded-lg bg-[hsl(var(--foreground))] px-3 text-sm font-medium leading-6 text-primary-foreground transition-colors hover:bg-[hsl(var(--primary))] hover:text-[hsl(var(--foreground))]"
          >
            <Plus
              className="h-4 w-4 text-primary-foreground/90 group-hover:text-[hsl(var(--foreground))]"
      ...
      <DialogContent
        ...
        <div className="mt-5 flex justify-end gap-2">
          ...
          <button
            ...
            className="inline-flex h-10 items-center gap-1.5 rounded-lg bg-[hsl(var(--destructive))] px-4 text-sm font-medium leading-6 text-primary-foreground transition-colors hover:bg-[hsl(var(--destructive))] disabled:opacity-50"
          >
