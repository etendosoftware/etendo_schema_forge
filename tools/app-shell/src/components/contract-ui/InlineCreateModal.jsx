      ...
      <DialogContent className="max-w-md gap-0 rounded-lg bg-card p-6" data-testid="inline-create-modal">
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className="h-10 w-full rounded-lg border border-[hsl(var(--border-control))] bg-card px-3 text-sm shadow-[0px_1px_2px_hsl(var(--foreground) / 0.05)] placeholder:text-[hsl(var(--muted-foreground))] focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
          />
        ...
        <div className="mt-5 flex justify-end gap-2">
          ...
          <button
            ...
            onClick={submit}
            disabled={!canSubmit}
            className="inline-flex h-10 shrink-0 items-center justify-center rounded-full px-4 py-2 text-sm font-medium leading-6 text-white transition-colors disabled:bg-[hsl(var(--border-control))] disabled:text-white enabled:bg-[hsl(var(--foreground))] enabled:hover:bg-[hsl(var(--primary))] enabled:hover:text-[hsl(var(--foreground))]"
          >
