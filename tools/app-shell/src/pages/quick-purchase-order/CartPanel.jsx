...
export default function CartPanel({
  lines, dispatch, onCreateOrder, onSendOrder, onCancel,
  activeTab, onTabChange, supplierId, onRepeatOrder, previousOrders,
}) {
  const ui = useUI();
