...
const fields = [
  ...
  { key: 'estado', column: 'Estado', type: 'text', label: 'Estado', readOnly: true, section: 'other', maxLength: 10 },
  { key: 'descripcion', column: 'Descripcion', type: 'text', label: 'Descripción', readOnly: true, section: 'other', maxLength: 20 },
