...
const fields = [
  ...
  { key: 'invoiceDescription', column: 'Invoice_Description', type: 'textarea', label: 'Descripción de Facturas', required: true, section: 'principal', defaultValue: 'Descripcion Factura', maxLength: 60 },
  ...
  { key: 'jasperreportPath', column: 'Jasperreport_Path', type: 'text', label: 'Ruta de Reporte Jasper', section: 'other', maxLength: 500 },
