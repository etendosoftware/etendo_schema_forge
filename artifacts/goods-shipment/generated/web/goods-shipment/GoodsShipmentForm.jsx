...
const fields = [
  ...
  { key: 'etgoCurrency', column: 'EM_ETGO_Currency_ID', type: 'selector', label: 'EM_ETGO_Currency_ID', required: true, section: 'principal', reference: 'Currency', inputMode: 'selector', readOnlyLogic: (record) => (record['processed'] === true || record['processed'] === 'Y') },
  ...
  { key: 'description', column: 'Description', type: 'textarea', label: 'Description', section: 'collapsed', maxLength: 255 },
...
GoodsShipmentForm.fields = fields;
