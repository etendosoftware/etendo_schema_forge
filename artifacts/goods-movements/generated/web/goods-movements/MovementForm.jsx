...
const fields = [
  ...
  { key: 'documentNo', column: 'DocumentNo', type: 'text', label: 'Document No.', readOnly: true, section: 'principal', maxLength: 30, readOnlyLogic: (record) => (record['processed'] === true || record['processed'] === 'Y') },
];
