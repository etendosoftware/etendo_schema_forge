...
const fields = [
  ...
  { key: 'aprmGlitemDiff', column: 'EM_Aprm_Glitem_Diff', type: 'selector', label: 'Accounting Account Difference', section: 'other', reference: 'Glitem', inputMode: 'selector' },
  { key: 'iBAN', column: 'Iban', type: 'text', label: 'IBAN', section: 'other', maxLength: 34 },
  { key: 'swiftCode', column: 'Swiftcode', type: 'text', label: 'SWIFT Code', section: 'other', maxLength: 20 },
  ...
  { key: 'bankCode', column: 'Codebank', type: 'text', label: 'Bank Code', section: 'other', maxLength: 4 },
  { key: 'branchCode', column: 'Codebranch', type: 'text', label: 'Branch Code', section: 'other', maxLength: 4 },
  { key: 'partialAccountNo', column: 'Codeaccount', type: 'text', label: 'Partial Account No.', section: 'other', maxLength: 10 },
  { key: 'accountNo', column: 'Accountno', type: 'text', label: 'Displayed Account', section: 'other', maxLength: 120 },
  ...
  { key: 'pSD2StatementFrequency', column: 'EM_PSD2_Statement_Frequency', type: 'select', label: 'Statement Grouping', section: 'other', options: [{ value: '1BE', label: 'New statement each run', labels: {"es_ES":"New statement each run"} }, { value: '1BD', label: 'Within 1 day', labels: {"es_ES":"Within 1 day"} }, { value: '1BW', label: 'Within 7 days', labels: {"es_ES":"Within 7 days"} }, { value: '1BM', label: 'Within 30 days', labels: {"es_ES":"Within 30 days"} }], defaultValue: '1BD' },
  { key: 'pSD2SaltEdgeAccountID', column: 'EM_PSD2_Salt_Edge_Account_ID', type: 'text', label: 'Salt Edge Account ID', readOnly: true, section: 'other', maxLength: 255 },
  { key: 'pSD2CardNumber', column: 'EM_PSD2_Masked_Pan', type: 'text', label: 'Card Number', readOnly: true, section: 'other', maxLength: 20 },
