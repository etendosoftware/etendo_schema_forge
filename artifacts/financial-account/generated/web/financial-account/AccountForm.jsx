...
const fields = [
  ...
  { key: 'type', column: 'Type', type: 'select', label: 'Type', required: true, section: 'principal', options: [{ value: 'B', label: 'Bank', labels: {"es_ES":"Bank"} }, { value: 'CA', label: 'Card', labels: {"es_ES":"Card"} }, { value: 'C', label: 'Cash', labels: {"es_ES":"Cash"} }], defaultValue: 'B' },
