...
const fields = [
  ...
  { key: 'referenceNo', column: 'Referenceno', type: 'text', label: 'Reference No.', required: true, section: 'principal', maxLength: 30, readOnlySource: 'server', readOnlyLogicReason: 'session-variable' },
  { key: 'bpartnername', column: 'Bpartnername', type: 'text', label: 'Business Partner Name', section: 'principal', maxLength: 60, readOnlySource: 'server', readOnlyLogicReason: 'session-variable' },
...
BankStatementLinesForm.fields = fields;
