...
const fields = [
  ...
  { key: 'endingDate', column: 'Dateto', type: 'date', label: 'Ending Date', required: true, readOnly: true, section: 'other', readOnlyLogic: (record) => (record['processed'] === true || record['processed'] === 'Y') },
