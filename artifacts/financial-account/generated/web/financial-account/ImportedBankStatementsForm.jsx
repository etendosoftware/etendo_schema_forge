...
const fields = [
  { key: 'documentNo', column: 'DocumentNo', type: 'text', label: 'Document No.', required: true, readOnly: true, section: 'other', maxLength: 30, readOnlyLogic: (record) => (record['processed'] === true || record['processed'] === 'Y') },
  ...
  { key: 'active', column: 'Isactive', type: 'checkbox', label: 'Active', section: 'principal', defaultValue: 'Y', readOnlyLogic: (record) => (record['processed'] === true || record['processed'] === 'Y') },
  { key: 'importdate', column: 'Importdate', type: 'date', label: 'Import Date', required: true, readOnly: true, section: 'other', readOnlyLogic: (record) => (record['processed'] === true || record['processed'] === 'Y') },
  { key: 'transactionDate', column: 'Statementdate', type: 'date', label: 'Transaction Date', required: true, readOnly: true, section: 'other', readOnlyLogic: (record) => (record['processed'] === true || record['processed'] === 'Y') },
  { key: 'fileName', column: 'Filename', type: 'text', label: 'File Name', readOnly: true, section: 'other', maxLength: 255, readOnlyLogic: (record) => (record['processed'] === true || record['processed'] === 'Y') },
  { key: 'notes', column: 'Notes', type: 'textarea', label: 'Notes', section: 'principal', maxLength: 255 },
