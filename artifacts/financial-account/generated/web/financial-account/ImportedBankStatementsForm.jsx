...
const fields = [
  ...
  { key: 'name', column: 'Name', type: 'text', label: 'Name', required: true, section: 'principal', maxLength: 60, readOnlyLogic: (record) => record['processed'] === true },
  ...
  { key: 'fileName', column: 'Filename', type: 'text', label: 'File Name', readOnly: true, section: 'other', maxLength: 255, readOnlyLogic: (record) => record['processed'] === true },
