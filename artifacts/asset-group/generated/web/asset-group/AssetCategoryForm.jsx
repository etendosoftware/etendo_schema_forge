...
const fields = [
  ...
  { key: 'annualDepreciation', column: 'Annualamortizationpercentage', type: 'number', label: 'Annual Depreciation %', section: 'principal', min: 1, displayLogic: (record) => (record.depreciate === true || record.depreciate === 'Y') && record.calculateType === 'PE' },
  ...
  { key: 'usableLifeYears', column: 'UseLifeYears', type: 'number', label: 'Usable Life - Years', section: 'principal', min: 1, integer: true, displayLogic: (record) => (record.depreciate === true || record.depreciate === 'Y') && record.calculateType === 'TI' && record.amortize === 'YE' },
  { key: 'usableLifeMonths', column: 'UseLifeMonths', type: 'number', label: 'Usable Life - Months', section: 'principal', min: 1, integer: true, displayLogic: (record) => (record.depreciate === true || record.depreciate === 'Y') && record.calculateType === 'TI' && record.amortize !== 'YE' },
];
...
AssetCategoryForm.fields = fields;
