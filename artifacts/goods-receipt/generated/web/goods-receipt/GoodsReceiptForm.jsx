...
const fields = [
  ...
  { key: 'movementDate', column: 'MovementDate', type: 'date', label: 'Movement Date', required: true, section: 'principal', defaultValue: '@Today@', readOnlyLogic: (record) => record['processed'] === true },
