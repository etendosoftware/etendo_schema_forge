...
const fields = [
  ...
  { key: 'attributeSetValue', column: 'M_AttributeSetInstance_ID', type: 'text', label: 'Attribute Set Value', required: true, readOnly: true, section: 'other', maxLength: 22 },
...
ProductTransactionsForm.fields = fields;
