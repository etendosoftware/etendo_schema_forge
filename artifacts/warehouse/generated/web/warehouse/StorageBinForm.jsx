...
const fields = [
  ...
  { key: 'rowX', column: 'X', type: 'text', label: 'Row (X)', required: true, section: 'principal', maxLength: 60 },
  { key: 'stackY', column: 'Y', type: 'text', label: 'Stack (Y)', required: true, section: 'principal', maxLength: 60 },
  { key: 'levelZ', column: 'Z', type: 'text', label: 'Level (Z)', required: true, section: 'principal', maxLength: 60 },
  { key: 'relativePriority', column: 'PriorityNo', type: 'number', label: 'Relative Priority', required: true, section: 'other', defaultValue: '50' },
  { key: 'barcode', column: 'Barcode', type: 'text', label: 'Barcode', section: 'other', maxLength: 30 },
