...
const fields = [
  ...
  { key: 'phone', column: 'Phone', type: 'text', label: 'Phone', section: 'other', maxLength: 40 },
  { key: 'alternativePhone', column: 'Phone2', type: 'text', label: 'Alternative Phone', section: 'principal', maxLength: 40 },
  { key: 'name', column: 'Name', type: 'text', labels: {"en_US":"Location / Address","es_ES":"Dirección"}, label: 'Name', required: true, section: 'principal', defaultValue: '.', maxLength: 60 },
  { key: 'fax', column: 'Fax', type: 'text', label: 'Fax', section: 'principal', maxLength: 40 },
