...
export default function BusinessPartnerPage({ windowName, recordId, ...props }) {
  ...
  return (
    <ListView
      ...
      labelOverrides={labelOverrides}
      rowQuickActions={{}}
      import={{"enabled":true,"spec":"contacts","entity":"businessPartner","formats":["csv","txt"],"limit":{"maxRows":5000,"concurrency":4},"dedupe":{"scope":"file","key":["etgoEmail"]},"descriptor":"contacts","fields":[{"target":"name","aliases":["nombre comercial","razon social"],"label":"Commercial Name","required":true,"type":"string"},{"required":false,"type":"string","target":"categoryCode","aliases":["codigo categoria","código categoría","codigo de categoria","código de categoría","codigocategoria","códigocategoría"],"label":"Contact Category Code"},{"required":false,"type":"string","target":"categoryName","aliases":["nombre categoria","nombre categoría","nombre de categoria","nombre de categoría","nombrecategoria","nombrecategoría"],"label":"Contact Category Name"},{"required":false,"type":"string","target":"category","aliases":["categoria","categoría","categoria de contacto","categoría de contacto"],"label":"Contact Category"},{"target":"etgoFirstname","aliases":["nombre"],"label":"First Name (Company)","required":false,"type":"string"},{"target":"etgoLastname","aliases":["apellido","apellidos"],"label":"Last Name (Company)","required":false,"type":"string"},{"target":"etgoEmail","aliases":["email","correo","e-mail"],"isEmail":true,"label":"Email (Company)","required":false,"type":"string"},{"target":"etgoPhone","aliases":["telefono","teléfono"],"label":"Phone (Company)","required":false,"type":"string"},{"target":"etgoWeb","aliases":["web","website","sitio web","pagina web","página web"],"label":"Website (Company)","required":false,"type":"string"},{"target":"oBTIKTaxIDKey","aliases":["clave nif pais residencia","clave nif país residencia","tipo identificacion fiscal","tipo identificación fiscal","tax id type"],"label":"Tax ID Type","required":false,"type":"enum"},{"target":"taxID","aliases":["cif/nif","cif","nif","tax id","taxid","identificacion fiscal","identificación fiscal"],"label":"CIF/NIF","required":false,"type":"string"},{"target":"email","aliases":["email de contacto"],"isEmail":true,"label":"Email (Contact)","required":false,"type":"string"},{"target":"firstName","aliases":["nombre de contacto"],"label":"First Name (Contact)","required":false,"type":"string"},{"target":"lastName","aliases":["apellido de contacto"],"label":"Last Name (Contact)","required":false,"type":"string"},{"target":"phone","aliases":["telefono de contacto"],"label":"Phone (Contact)","required":false,"type":"string"},{"target":"position","aliases":["cargo"],"label":"Position","required":false,"type":"string"},{"required":false,"type":"string","target":"address","aliases":["direccion","dirección"],"label":"Address"},{"required":false,"type":"string","target":"city","aliases":["ciudad"],"label":"City"},{"required":false,"type":"string","target":"postal","aliases":["codigo postal","código postal","cp"],"label":"Postal Code"},{"target":"country","aliases":["pais","país"],"label":"Country","matchEntity":"Country","required":false,"type":"foreignKey","reference":"Country"},{"required":false,"type":"string","target":"region","aliases":["provincia","region","región"],"label":"Region"}]}}
      {...props} window={effectiveWindow}
    />
  );
}
