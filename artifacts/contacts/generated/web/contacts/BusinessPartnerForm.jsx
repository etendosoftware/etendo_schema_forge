...
const fields = [
  { key: 'etgoIdentifier', column: 'EM_Etgo_Identifier', type: 'text', label: 'Identifier', readOnly: true, section: 'principal', maxLength: 32 },
  { key: 'name', column: 'Name', type: 'text', label: 'Commercial Name', required: true, section: 'principal', maxLength: 60 },
  { key: 'businessPartnerCategory', column: 'C_BP_Group_ID', type: 'selector', label: 'Contact Category', required: true, section: 'principal', reference: 'BusinessPartnerCategory', inputMode: 'selector', defaultValue: '@SQL=SELECT MAX(C_BP_GROUP_ID) FROM C_BP_GROUP WHERE AD_ISORGINCLUDED(@AD_ORG_ID@, AD_ORG_ID, @#AD_CLIENT_ID@) <> -1 AND ISDEFAULT = \'Y\' AND AD_CLIENT_ID = @#AD_CLIENT_ID@' },
  { key: 'etgoFirstname', column: 'EM_Etgo_Firstname', type: 'text', label: 'First Name', required: true, section: 'principal', maxLength: 60 },
  { key: 'etgoLastname', column: 'EM_Etgo_Lastname', type: 'text', label: 'Last Name', required: true, section: 'principal', maxLength: 60 },
  { key: 'oBTIKTaxIDKey', column: 'EM_OBTIK_Tax_ID_Key', type: 'select', label: 'Clave NIF País Residencia', required: true, section: 'principal', options: [{ value: '1', label: 'NIF', labels: {"es_ES":"NIF"} }, { value: '2', label: 'NIF Intracomunitario', labels: {"es_ES":"NIF Intracomunitario"} }, { value: '3', label: 'Pasaporte', labels: {"es_ES":"Pasaporte"} }, { value: '4', label: 'Documento oficial de identificación expedido por el país', labels: {"es_ES":"Documento oficial de identificación expedido por el país"} }, { value: '5', label: 'Certificado de residencia fiscal', labels: {"es_ES":"Certificado de residencia fiscal"} }, { value: '6', label: 'Otro documento probatorio', labels: {"es_ES":"Otro documento probatorio"} }, { value: '7', label: 'No Censado', labels: {"es_ES":"No Censado"} }], defaultValue: '\'1\'' },
  { key: 'taxID', column: 'TaxID', type: 'text', label: 'Tax ID', section: 'principal', maxLength: 20 },
