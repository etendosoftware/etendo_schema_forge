...
const fields = [
  ...
  { key: 'oBTIKVIESStatus', column: 'EM_OBTIK_VIESStatus', type: 'select', label: 'Estado VIES', readOnly: true, section: 'principal', options: [{ value: 'P', label: 'Pendiente' }, { value: 'V', label: 'Válido' }, { value: 'I', label: 'No válido' }], defaultValue: 'P', displayLogic: (record) => record.oBTIKTaxIDKey === '2' },
