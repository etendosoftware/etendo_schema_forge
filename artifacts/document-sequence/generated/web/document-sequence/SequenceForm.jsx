...
const fields = [
  { key: 'name', column: 'Name', type: 'select', label: 'Name', required: true, readOnly: true, section: 'principal', options: [{ value: 'Purchase Order', label: 'documentSequencePurchaseOrder' }, { value: 'Standard Order', label: 'documentSequenceSalesOrder' }, { value: 'AR Invoice', label: 'documentSequenceSalesInvoice' }, { value: 'Factura Rectificativa (Ventas)', label: 'documentSequenceSalesCorrectiveInvoice' }, { value: 'Factura Rectificativa (Compras)', label: 'documentSequencePurchaseCorrectiveInvoice' }] },
