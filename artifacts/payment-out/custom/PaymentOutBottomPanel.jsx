  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', padding: '8px 20px 12px', gap: 44 }}>
      <div style={{ width: 148, flexShrink: 0 }}>
        <div style={{ font: '600 14px/20px Inter', color: '#121217' }}>{ui('paymentOutDataTitle')}</div>
        <div style={{ font: '400 12px/16px Inter', color: '#282833', marginTop: 4 }}>{ui('paymentOutDataSub')}</div>
      </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', padding: '8px 20px 12px', gap: 16 }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
        <div style={{ font: '600 14px/20px Inter', color: '#121217' }}>{ui('paymentOutLinesTitle')}</div>
        <div style={{ font: '400 12px/16px Inter', color: '#282833' }}>{ui('paymentOutLinesSub')}</div>
      </div>

      {lines === null ? (
        <div style={{ font: '400 13px/18px Inter', color: '#828FA3' }}>{ui('loading')}</div>
      ) : noLines ? (
        <div style={{ font: '400 13px/18px Inter', color: '#828FA3' }}>{ui('paymentOutNoLines')}</div>
      ) : (
