...
const fields = [
  ...
  { key: 'textCondition', column: 'TextCondition', type: 'select', label: 'Text Condition', required: true, searchSelect: true, section: 'general', options: [{ value: 'C', label: 'Contains', labels: {"es_ES":"Contains"} }, { value: 'R', label: 'Regex', labels: {"es_ES":"Regex"} }, { value: 'S', label: 'Starts with', labels: {"es_ES":"Starts with"} }], placeholderKey: 'matchRuleConditionPlaceholder' },
