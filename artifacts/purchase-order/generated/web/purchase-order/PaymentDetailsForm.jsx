...
const fields = [
  ...
  { key: 'status', column: 'Status', type: 'select', label: 'Status', required: true, readOnly: true, section: 'other', options: [{ value: 'RPAP', label: 'Awaiting Payment', labels: {"es_ES":"Awaiting Payment"} }, { value: 'RPAE', label: 'Awaiting Execution', labels: {"es_ES":"Awaiting Execution"} }, { value: 'RPVOID', label: 'Void', labels: {"es_ES":"Void"} }, { value: 'PPM', label: 'Payment Made', labels: {"es_ES":"Payment Made"} }, { value: 'RPR', label: 'Payment Received', labels: {"es_ES":"Payment Received"} }, { value: 'RDNC', label: 'Deposited not Cleared', labels: {"es_ES":"Deposited not Cleared"} }, { value: 'PWNC', label: 'Withdrawn not Cleared', labels: {"es_ES":"Withdrawn not Cleared"} }, { value: 'RPPC', label: 'Payment Cleared', labels: {"es_ES":"Payment Cleared"} }] },
];
