...
const fields = [
  ...
  { key: 'tbaiReverseinvoicecode', column: 'EM_Tbai_Reverseinvoicecode', type: 'select', label: 'Código de Factura Rectificativa', section: 'principal', options: [{ value: 'R5', label: 'Factura rectificativa en facturas simplificadas.' }, { value: 'R4', label: 'Factura rectificativa: Resto.' }, { value: 'R3', label: 'Factura rectificativa: artículo 80 Cuatro de la Ley del IVA.' }, { value: 'R2', label: 'Factura rectificativa: artículo 80 Tres de la Ley del IVA.' }, { value: 'R1', label: 'Factura rectificativa: error fundado en derecho' }], displayLogic: (record) => record['tbaiConfigActive'] !== 'N', readOnlyLogic: (record) => record['processed'] === true },
];
