...
const fields = [
  ...
  { key: 'motivo', column: 'Motivo', type: 'text', label: 'SII error reason', section: 'principal', maxLength: 255 },
  ...
  { key: 'cdigoCSV', column: 'Codigo_Csv', type: 'text', label: 'CSV code', section: 'principal', maxLength: 16 },
  ...
  { key: 'comunicacion', column: 'Comunicacion', type: 'select', label: 'Communication type', section: 'other', options: [{ value: 'A0', label: 'Alta en SII (A0)', labels: {"es_ES":"Alta en SII (A0)"} }, { value: 'A1', label: 'Modification to SII (A1)', labels: {"es_ES":"Modificación a SII (A1)"} }, { value: 'Q', label: 'SII Query', labels: {"es_ES":"Consulta SII"} }] },
];
...
ReceivedInvoicespreviousPeriodSiiDataForm.fields = fields;
