...
const fields = [
  ...
  { key: 'etgoBusinessType', column: 'EM_Etgo_Business_Type', type: 'select', label: 'Business Type', required: true, section: 'principal', options: [{ value: 'CO', label: 'Company', labels: {"es_ES":"Company"} }, { value: 'FL', label: 'Freelancer', labels: {"es_ES":"Freelancer"} }], defaultValue: 'CO' },
];
