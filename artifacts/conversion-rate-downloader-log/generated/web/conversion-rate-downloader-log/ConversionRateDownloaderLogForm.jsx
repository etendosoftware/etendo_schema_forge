...
const fields = [
  ...
  { key: 'syncDate', column: 'sync_date', type: 'text', label: 'Sync Date', readOnly: true, section: 'principal', maxLength: 19 },
  ...
  { key: 'errorDetail', column: 'error_detail', type: 'text', label: 'Error Detail', readOnly: true, section: 'principal', maxLength: 2000 },
