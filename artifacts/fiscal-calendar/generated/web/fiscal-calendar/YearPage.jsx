...
const processes = [
  { name: 'processNow', label: 'Create Periods', style: 'positive', params: [{"key":"FISCALYEARSTART","type":"select","label":"Fiscal Year Range","required":true,"options":[{"value":"JANUARY","label":"January - December"},{"value":"APRIL","label":"April - March"},{"value":"JULY","label":"July - June"},{"value":"OCTOBER","label":"October - September"}]},{"key":"CREATEADJUSTMENT","type":"select","label":"Create Adjustment Period","required":false,"options":[{"value":"N","label":"No"},{"value":"Y","label":"Yes"}]}] },
];
