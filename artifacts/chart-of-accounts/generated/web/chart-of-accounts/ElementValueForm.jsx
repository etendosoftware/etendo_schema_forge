...
const fields = [
  { key: 'searchKey', column: 'Value', type: 'text', label: 'Search Key', required: true, section: 'principal', maxLength: 40, readOnlyLogic: (record) => record['protectedParentLikeSubaccount'] === 'Y', customRenderer: AccountCodeField },
  { key: 'name', column: 'Name', type: 'text', label: 'Name', required: true, section: 'principal', maxLength: 255, readOnlyLogic: (record) => record['protectedParentLikeSubaccount'] === 'Y' },
  { key: 'description', column: 'Description', type: 'textarea', label: 'Description', section: 'principal', maxLength: 255, readOnlyLogic: (record) => record['protectedParentLikeSubaccount'] === 'Y' },
...
ElementValueForm.fields = fields;
