...
const fields = [
  ...
  { key: 'taxCategory', column: 'C_TaxCategory_ID', type: 'selector', label: 'Tax Category', required: true, readOnly: true, section: 'principal', reference: 'TaxCategory', inputMode: 'selector' },
  { key: 'validFrom', column: 'ValidFrom', type: 'date', label: 'Valid From Date', required: true, readOnly: true, section: 'principal' },
  { key: 'docTaxAmount', column: 'DocTaxAmount', type: 'select', label: 'Document Tax Amount Calculation', required: true, readOnly: true, section: 'principal', options: [{ value: 'D', label: 'Document based amount by rate', labels: {"es_ES":"Suma de las bases imponibles de las lineas por el porcentaje"} }, { value: 'L', label: 'Line based amount by rate', labels: {"es_ES":"Suma del importe de los impuestos de las lineas"} }], defaultValue: 'D' },
  { key: 'baseAmount', column: 'BaseAmount', type: 'select', label: 'Base Amount', required: true, readOnly: true, section: 'principal', options: [{ value: 'TBA', label: 'Alternate Tax Base Amount', labels: {"es_ES":"Base de impuesto alternativa"} }, { value: 'TBATAX', label: 'Alternate Tax Base Amount + Tax Amount', labels: {"es_ES":"Base imponible alternativa + Impuestos"} }, { value: 'LNA', label: 'Line Net Amount', labels: {"es_ES":"Importe neto de línea"} }, { value: 'LNATAX', label: 'Line Net Amount + Tax Amount', labels: {"es_ES":"Importe neto de línea + Importe de impuestos"} }, { value: 'TAX', label: 'Tax Amount', labels: {"es_ES":"Importe de impuestos"} }], defaultValue: 'LNA' },
];
