...
// @sf-generated-start fields:facturasAceptadas
const fields = [
  ...
  { key: 'cSV', column: 'Csv', type: 'text', label: 'CSV', section: 'other', maxLength: 16 },
  ...
  { key: 'codeError', column: 'Code_Error', type: 'text', label: 'Código de Error', section: 'other', maxLength: 20 },
...
// @sf-generated-end fields:facturasAceptadas

// @sf-generated-start component:FacturasAceptadasForm
export default function FacturasAceptadasForm(props) {
  return <EntityForm fields={fields} {...props} />;
}
FacturasAceptadasForm.fields = fields;

// @sf-generated-end component:FacturasAceptadasForm
