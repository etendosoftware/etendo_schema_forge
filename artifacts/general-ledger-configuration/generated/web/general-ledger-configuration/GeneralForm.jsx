...
const fields = [
  ...
  { key: 'name', column: 'Name', type: 'text', label: 'Name', required: true, section: 'identity', maxLength: 60 },
  { key: 'description', column: 'Description', type: 'textarea', label: 'Description', section: 'identity', maxLength: 255 },
