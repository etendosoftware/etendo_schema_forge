...
const fields = [
  ...
  { key: 'orderReference', column: 'POReference', type: 'text', label: 'Supplier Reference', section: 'principal', readOnlyLogic: (record) => record['aeatsiiIssent'] === true && record['salesTransaction'] !== true },
