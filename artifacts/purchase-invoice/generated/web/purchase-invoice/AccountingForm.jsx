...
const fields = [
  ...
  { key: 'postingType', column: 'PostingType', type: 'select', label: 'Posting Type', required: true, readOnly: true, section: 'other', options: [{ value: 'A', label: 'Actual', labels: {"es_ES":"Actual"} }, { value: 'B', label: 'Budget', labels: {"es_ES":"Budget"} }, { value: 'E', label: 'Encumbrance', labels: {"es_ES":"Encumbrance"} }, { value: 'S', label: 'Statistical', labels: {"es_ES":"Statistical"} }] },
];
