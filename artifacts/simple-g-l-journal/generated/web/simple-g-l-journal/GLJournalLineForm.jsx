...
const fields = [
  ...
  { key: 'foreignCurrencyDebit', column: 'AmtSourceDr', type: 'number', labels: {"en_US":"Debit","es_ES":"Débito"}, label: 'Debit', required: true, section: 'principal', readOnlyLogic: (record) => record['processed'] === true },
  { key: 'foreignCurrencyCredit', column: 'AmtSourceCr', type: 'number', labels: {"en_US":"Credit","es_ES":"Crédito"}, label: 'Credit', required: true, section: 'principal', readOnlyLogic: (record) => record['processed'] === true },
  ...
  { key: 'product', column: 'M_Product_ID', type: 'selector', label: 'Product', section: 'other', reference: 'Product', inputMode: 'selector', visible: null, visibilitySource: 'server', displayLogicReason: 'server-macro', readOnlyLogic: (record) => record['posted'] === true },
