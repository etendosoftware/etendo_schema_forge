...
const columns = [
  { key: 'description', column: 'Description', type: 'string', label: 'Description', required: true, maxLength: 255 },
...
const filters = ['description', 'accountingDate', 'period', 'currency', 'posted', 'documentStatus'];
