...
const fields = [
  { key: 'accountingDate', column: 'DateAcct', type: 'date', labels: {"en_US":"Date","es_ES":"Fecha"}, label: 'Accounting Date', required: true, section: 'principal', defaultValue: '@SQL=SELECT COALESCE((SELECT ENDDATE FROM C_PERIOD WHERE C_PERIOD_ID = @C_PERIOD_ID@ and periodtype = \'A\'),to_date(@HeaderDateAcct@)) FROM DUAL', readOnlyLogic: (record) => record['posted'] === true },
