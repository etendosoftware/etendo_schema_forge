...
const tableSrc = readFileSync(
  join(__dirname, '..', 'web', 'simple-g-l-journal', 'GLJournalTable.jsx'),
  'utf8'
);

const pageSrc = readFileSync(
  join(__dirname, '..', 'web', 'simple-g-l-journal', 'GLJournalPage.jsx'),
  'utf8'
);
...
describe('Simple GL Journal GLJournalTable — posted badge column', () => {
...
describe('Simple GL Journal GLJournalPage — post and unpost menuActions', () => {
