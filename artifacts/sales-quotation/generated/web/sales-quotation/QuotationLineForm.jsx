...
const fields = [
  ...
  { key: 'orderedQuantity', column: 'QtyOrdered', type: 'number', label: 'Ordered Quantity', required: true, section: 'principal', defaultValue: '1', min: 0, readOnlySource: 'server', readOnlyLogicReason: 'session-variable' },
  { key: 'listPrice', column: 'PriceList', type: 'number', label: 'Net List Price', required: true, section: 'principal', min: 0, readOnlyLogic: (record) => record['processed'] === true },
  { key: 'discount', column: 'Discount', type: 'number', label: 'Discount', section: 'other', defaultValue: '0', min: 0, readOnlyLogic: (record) => record['processed'] === true },
