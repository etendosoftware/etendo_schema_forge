...
const fields = [
  ...
  { key: 'multipleRateBy', column: 'MultiplyRate', type: 'text', label: 'Multiple Rate By', required: true, section: 'other', maxLength: 22, readOnlyLogic: (record) => record['sMFCRSynced'] === true },
  { key: 'divideRateBy', column: 'DivideRate', type: 'text', label: 'Divide Rate By', required: true, section: 'other', maxLength: 22, readOnlyLogic: (record) => record['sMFCRSynced'] === true },
