...
- **React component / plain module:** `csvField(value)` from `@etendosoftware/app-shell-core/lib/csv/csvSerializer.js` — neutralize plus RFC 4180 quoting, in that order.
