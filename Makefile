...
file-lines-budget: ## Ratchet guard: fail only if a tracked file grew past its line baseline (--list to enumerate, --update to lower it)
	$(SF) sf-file-lines-budget --list
