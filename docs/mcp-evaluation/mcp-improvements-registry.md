...
| **Today** (2026-08-12) — quota re-based to 126 for IMP-26 + IMP-27; **no code changed and no status moved** | **80 %** | **1.4×** | **49.0 / 126** | 6 / 6 | **70** |
| **Registry closed** — all 27 ✅, full probe surface, M1 at its target | 90 % | 1.2× | 105 / 126 | 6 / 6 | **88** |
...
**Totals (2026-08-12):** earned **49.0** of a known scope of **105** (C1 32/40 · C2 11.5/21 ·
C3 2.5/20 · C4 3/16 · C5 0/8) against a re-based quota of **126** (§2.2) → the Delivery component of
MARI = **39** (§2.1). Verify the column sums before publishing; a `Pts` cell that disagrees with its
...
> ✅ **The reserve was exhausted on 2026-08-10 and re-based on 2026-08-12.** Known scope (105) now
> sits **21 points below** the quota (126), so the next run has room to register what it finds. The
