...
* **IMP-48 is 🔧, not ✅.** The code is committed and no live call has confirmed it, which scores
  zero exactly like ⏳. Nothing in this entry is re-based on it.
