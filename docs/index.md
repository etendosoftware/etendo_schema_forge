...
| [document-printables.md](document-printables.md) | Document printables (`print-*`): contract SQL, the two render paths, the shared QR helper, and how to change one safely |
