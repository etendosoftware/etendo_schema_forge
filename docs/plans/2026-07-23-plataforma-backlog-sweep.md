...
- [x] ETP-4280 (5/7 quick wins) — **no runtime code fix**, resolved as a validator-side diagnostic gap by an externally-dispatched dev agent, Alex + Sentinel approved, reported via `/tmp/ready-etp-4280.md`:
  ...
  - **In progress:** asked Clerk-sf to merge this docs-only commit into `feature/ETP-4657` in `etendo_schema_forge`. Expect the already-known epic-conflict to block the push again (deferred, not blocking).
...
- [ ] Remaining quick win: ETP-4287 — NOT started.
